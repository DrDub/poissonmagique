...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Queue'
        db.create_table(u'poissonmagique_queue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('maildir', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024, db_index=True)),
        ))
        db.send_create_signal(u'poissonmagique', ['Queue'])

        # Adding model 'MessageID'
        db.create_table(u'poissonmagique_messageid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('queue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poissonmagique.Queue'])),
        ))
        db.send_create_signal(u'poissonmagique', ['MessageID'])

        # Adding field 'Message.message_id'
        db.add_column(u'poissonmagique_message', 'message_id',
                      self.gf('django.db.models.fields.CharField')(default='unknown', unique=True, max_length=255, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Queue'
        db.delete_table(u'poissonmagique_queue')

        # Deleting model 'MessageID'
        db.delete_table(u'poissonmagique_messageid')

        # Deleting field 'Message.message_id'
        db.delete_column(u'poissonmagique_message', 'message_id')

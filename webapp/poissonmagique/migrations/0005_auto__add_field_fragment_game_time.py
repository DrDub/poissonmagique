...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fragment.game_time'
        db.add_column(u'poissonmagique_fragment', 'game_time',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fragment.game_time'
        db.delete_column(u'poissonmagique_fragment', 'game_time')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.game_time'
        db.add_column(u'poissonmagique_campaign', 'game_time',
                      self.gf('django.db.models.fields.CharField')(default='100: before start', max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.game_time'
        db.delete_column(u'poissonmagique_campaign', 'game_time')
